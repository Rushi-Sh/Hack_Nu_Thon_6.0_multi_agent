...
def frontend_pipeline(website_content, requirements_content, figma_json=None):
    """Executes Frontend testing using LangGraph."""
    ...
    return compiled_graph.invoke({"website_content": website_content, "requirements_content": requirements_content, "figma_json": figma_json})
